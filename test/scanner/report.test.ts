        ...
        packages: [
          {
            ...
            infos: 1,
            results: [
              { rule: "test/rule1", message: "Missing field", severity: "error", fix: false },
              { rule: "test/rule2", message: "Missing field", severity: "error", fix: false },
              { rule: "test/rule3", message: "Deprecated usage", severity: "warning", fix: false },
              { rule: "test/rule4", message: "Deprecated usage", severity: "warning", fix: false },
              { rule: "test/rule5", message: "Consider adding", severity: "warning", fix: false },
              { rule: "test/rule6", message: "Info message", severity: "info", fix: false },
            ],
          },
        ],
      },
        ...
        packages: [
          {
            ...
            infos: 0,
            results: [
              { rule: "test/rule7", message: "Deprecated usage", severity: "warning", fix: false },
            ],
          },
        ],
      },
        ...
        packages: [
          {
            ...
            infos: 0,
            results: [
              { rule: "test/rule", message: "Error", severity: "error", fix: false },
            ],
          },
          {
            name: "pkg2",
            ...
            infos: 0,
            results: [
              { rule: "test/rule", message: "Warning", severity: "warning", fix: false },
              { rule: "test/rule", message: "Warning", severity: "warning", fix: false },
            ],
          },
        ],
        ...
        packages: [
          {
            ...
            infos: 0,
            results: [
              { rule: "test/rule", message: "Missing field", severity: "error", fix: false },
              { rule: "test/rule", message: "Missing field", severity: "error", fix: false },
            ],
          },
        ],
